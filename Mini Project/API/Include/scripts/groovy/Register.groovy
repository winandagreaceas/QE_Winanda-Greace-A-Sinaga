...
class Register {
	...
	def setUrlR1() {
		...
		response = WS.sendRequest(findTestObject('Object Repository/Postman/Authentication/Successful Registration'))
	}
	...
	@When("I set URL R2")
	def setUrlR2() {
		response = WS.sendRequest(findTestObject('Object Repository/Postman/Authentication/Registration with Existing Email'))
	}
	...
	@When("I set URL R3")
	def setUrlR3() {
		response = WS.sendRequest(findTestObject('Object Repository/Postman/Authentication/Registration with Empty Data on Field'))
	}
