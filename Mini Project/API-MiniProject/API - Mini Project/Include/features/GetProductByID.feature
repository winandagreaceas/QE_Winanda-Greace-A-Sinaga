...
Feature: Get All Products
  ...
  @GetProductByID.ID1
  Scenario Outline: Verify that users can successfully retrieve product details with valid ID.
  ...
  @GetProductByID.ID2
  Scenario Outline: Verify that users failed retrieve product details with invalid ID.
