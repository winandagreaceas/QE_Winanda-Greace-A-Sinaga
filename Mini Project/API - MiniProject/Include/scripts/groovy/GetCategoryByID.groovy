...
class GetCategoryByID {
	...
	def setUrlCID1() {
		...
		WS.sendRequest(findTestObject('Object Repository/Product Categories/GetCategoryByID/016-GetCategoryByID'))
	}
	...
	def setUrlCID2() {
		...
		WS.sendRequest(findTestObject('Object Repository/Product Categories/GetCategoryByID/017-GetCategoryByID'))
	}
