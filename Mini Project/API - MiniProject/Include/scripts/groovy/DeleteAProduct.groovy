...
class DeleteAProduct {
	...
	def setUrlDEL1() {
		...
		WS.sendRequest(findTestObject('Object Repository/Products/DeleteAProduct/006-DeleteAProduct'))
	}
	...
	def setUrlDEL2() {
		...
		WS.sendRequest(findTestObject('Object Repository/Products/DeleteAProduct/007-DeleteAProduct'))
	}
