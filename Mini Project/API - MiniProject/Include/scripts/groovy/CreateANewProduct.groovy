...
class CreateANewProduct {
	...
	def setUrlCP1() {
		...
		WS.sendRequest(findTestObject('Object Repository/Products/CreateCommentForProduct/011-CreateCommentForProduct'))
	}
	...
	def setUrlCP2() {
		println ("https://altashop-api.fly.dev/api/products")
		WS.sendRequest(findTestObject('Object Repository/Products/CreateCommentForProduct/012-CreateCommentForProduct'))
	}
