...
class GetProductComments {
	...
	// TC-A-010 - Verify that users can successfully get product comments
	...
	def setUrlGPC1() {
		...
		WS.sendRequest(findTestObject('Object Repository/Products/GetProductComments/010-GetProductComments'))
	}
