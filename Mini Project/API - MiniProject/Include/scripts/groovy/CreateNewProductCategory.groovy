...
class CreateNewProductCategory {
	...
	def setUrlCPC1() {
		...
		WS.sendRequest(findTestObject('Object Repository/Product Categories/CreateNewProductCategory/013-CreateNewProductCategory'))
	}
	...
	def setUrlCPC2() {
		println ("https://altashop-api.fly.dev/api/categories")
		WS.sendRequest(findTestObject('Object Repository/Product Categories/CreateNewProductCategory/014-CreateNewProductCategory'))
	}
