...
class UserInfo {
	...
	// TC-A-024 - Verify that users can access their profile information
	...
	def setUrlU1() {
		...
		WS.sendRequest(findTestObject('Object Repository/Authentication/User Info/024-UserInfo'))
	}
