...
class AssignARatingForProduct {
	...
	def setUrlAR1() {
		...
		WS.sendRequest(findTestObject('Object Repository/Products/AssignARatingForProduct/009-AssignARatingForProduct'))
	}
