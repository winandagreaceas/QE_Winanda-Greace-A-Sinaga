...
WebUI.setText(findTestObject('Object Repository/Homepage/Categories/Category Selection/Page_frontend-web/input_Email_input-18'), 
    'winandasinaga22@gmail.com')

WebUI.setText(findTestObject('Object Repository/Homepage/Categories/Category Selection/Page_frontend-web/input_Password_input-21'), 
    'indomie')
