...
Mobile.tap(findTestObject('Object Repository/Mobile/Add New Item/001-Successful Addition of a New Item/android.widget.Button (4)'), 
    0)
...
Mobile.verifyElementVisible(findTestObject('Object Repository/Mobile/Add New Item/001-Successful Addition of a New Item/android.view.View (2)'), 
    0)
